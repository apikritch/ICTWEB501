      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="iframe-container">
            <iframe
              class="w-100 rounded"
              :src="`https://www.youtube.com/embed/${instructionGuide.youtubeId}`"
              frameborder="0"
...
export default {
  ...
  async mounted() {
    const instructionGuideId = this.$store.state.route.params
      .instructionGuideId;
    this.instructionGuide = (await InstructionGuideService.getInstructionGuideById(
      instructionGuideId
    )).data;
  }
};
